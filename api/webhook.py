...
firebase_admin.initialize_app(cred, {'storageBucket': 'vasustreamer-fd67f.appspot.com'})
db = firestore.client()
bucket = storage.bucket()

def generate_start_keyboard():
    keyboard = InlineKeyboardMarkup()
    keyboard.add(InlineKeyboardButton("Open Vasustreamer App", web_app=WebAppInfo(url="https://iridescent-flan-ac9aa1.netlify.app/")))
    return keyboard
